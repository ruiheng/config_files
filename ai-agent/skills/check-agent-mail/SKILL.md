...
5. If context is lost after `mailbox_ack`, use `mailbox_read` on the latest `acked` delivery for this session to recover the mailbox body before asking anyone to resend it
