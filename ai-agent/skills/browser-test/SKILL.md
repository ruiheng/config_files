...
6. after sending, immediately use `check-workflow-mail wait=True` in the foreground
...
- when idle, stay in `check-workflow-mail wait=True` in the foreground instead of exiting
