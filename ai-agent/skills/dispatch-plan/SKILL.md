...
14. after the send succeeds, report the sent status, do independent local work, or optionally wait
15. if a wait times out, either wait again or stop; do not inspect or repair the planner session
