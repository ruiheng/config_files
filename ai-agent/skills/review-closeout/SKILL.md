...
2. send mode:
   ...
   - otherwise send `closeout_delivered` to planner through `mailbox_deliver`
...
9. Use `mailbox_deliver` for normal cross-session closeout delivery
